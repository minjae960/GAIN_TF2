...
#              '3_AP_1_Seoul', '3_AP_2_BR', '3_AP_3_Ulsan', 서울, 울산: 파이참 / 백령: 코랩
            ...
            for missing_rate in Missing_Rate:
                ...
                for length in Length:
                    for iteration in range(N):
                        ...
                        print(data_name, missing_col, seed, missing_rate, length, iteration+1)
                        ...
                        if data_name == 'pm' or data_name == 'pm_wthr':
                            ...
                            D = pd.read_csv('data/{}_raw.csv'.format(data_name)).drop(columns='date').iloc[-24*length:].reset_index(drop=True)
                        ...
                        for i in range(int(R/L)):
                            ...
                            def train_lstm_gain(epochs): # inputting (1, sq, cols) size data with random order
                                ...
                                for epoch in tqdm(range(epochs)):
                                    ...
                                    if epoch+1 == epochs:
                                        ...
                                        print()
                                        print('Data name: {}, Column: {}, Seed: {}, Rate: {}, Length: {}, Iter: {}'.format(data_name, missing_col, seed, missing_rate, length, iteration+1))
                                        print('{}/{}th sample, G_loss is {} and D_loss is {}'.format(i+1, int(R/L), gen_loss, disc_loss))
                            ...
                            imputed = imputed * (max_vector - min_vector + 1e-10) + min_vector
                        ...
                        def save_csv():
                            ...
                            GAIN.to_csv('result_mr_length_2/{}_result_{}_GAIN_{}_missing_rate_{}_length_{}_{}.csv'.format(data_name, seed, missing_col, int(missing_rate*10), length, iteration+1), index=False)
                            KNN.to_csv('result_mr_length_2/{}_result_{}_KNN_{}_missing_rate_{}_length_{}_{}.csv'.format(data_name, seed, missing_col, int(missing_rate*10), length, iteration+1), index=False)

                            print()
                            print('{}_result_{}_GAIN|KNN_{}_missing_rate_{}_length_{}_{}.csv. Saved GAIN and KNN results'.format(data_name, seed, missing_col, int(missing_rate*10), length, iteration))
                            print()
